...
# Function to add a marker at a specific latitude and longitude (pass in an array of the cities similiar cities)
# References guide on OS module from GeeksforGeeks
def addTop5Markers(map, cities):
    icons = {1: os.path.join('..', 'resources', 'Icons', 'one.png'), #paths to each icon
...
def addBottom5Markers(map, cities):
    icons = {5: os.path.join('..', 'resources', 'Icons', 'one.png'), #paths to each icon
             4: os.path.join('..', 'resources', 'Icons', 'two.png'),
             3: os.path.join('..', 'resources', 'Icons', 'three.png'),
             2: os.path.join('..', 'resources', 'Icons', 'four.png'),
